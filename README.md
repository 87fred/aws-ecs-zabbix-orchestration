...
* 
* **Segurança por padrão:** Mitigação de vulnerabilidades e exposição zero de dados sensíveis.
* 
...
A infraestrutura conta com monitoramento centralizado via Amazon CloudWatch, configurado para atuar sobre os Golden Signals e garantir a saúde do sistema.
